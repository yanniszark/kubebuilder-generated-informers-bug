...
import (
	"context"
	shipsv1 "github.com/yanniszark/kubebuilder-generated-informers-bug/pkg/apis/ships/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &shipsv1.Sloop{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
